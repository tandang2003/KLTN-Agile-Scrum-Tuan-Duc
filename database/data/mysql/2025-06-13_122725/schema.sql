...
CREATE TABLE `issue_relation` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `FK1142k1u0f8stkgxhwkt9sg3ou` FOREIGN KEY (`id`) REFERENCES `issues` (`id`)
...
CREATE TABLE `resources` (
  ...
  `name` varchar(255) DEFAULT NULL,
  `place_content` enum('ISSUE','AVATAR','PROJECT') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
