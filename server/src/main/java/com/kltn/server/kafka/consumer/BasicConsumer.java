...
//    correct object sent with topic
//    @KafkaListener(topics = "quickstart-object", groupId = "qus-obj-1")
//    public void consumeObj(Customer message) {
//        logger.info("ConsumedObj message: {}", message);
//    }
}
