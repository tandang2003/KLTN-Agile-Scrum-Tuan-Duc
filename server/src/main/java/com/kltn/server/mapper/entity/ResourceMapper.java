...
//            @Mapping(target = "publicId", source = "publicId"),
  ...
  @Mappings({@Mapping(target = "name",
             ...
             @Mapping(target = "contentType",
                      source = "contentType"),
             @Mapping(target = "placeContent",
                      expression = "java(com.kltn.server.model.type.resource.PlaceContent.ISSUE)"),
             @Mapping(target = "size",
                      source = "size"),
             @Mapping(target = "publicId",
                      source = "publicId"),})
  @BeanMapping(ignoreByDefault = true)
...
//            @Mapping(target = "publicId", source = "publicId"),
  ...
  @Mappings({@Mapping(target = "nkResourceId",
                      source = "id"),
             @Mapping(target = "name",
                      source = "name"),
             @Mapping(target = "extension",
...
//            @Mapping(target = "publicId", source = "publicId"),
  ...
  @Mappings({@Mapping(target = "name",
             ...
             @Mapping(target = "contentType",
                      source = "contentType"),
             @Mapping(target = "placeContent",
                      expression = "java(com.kltn.server.model.type.resource.PlaceContent.PROJECT)"),
             @Mapping(target = "size",
                      source = "size"),
             @Mapping(target = "publicId",
                      source = "publicId"),})
