...
@Mapper(componentModel = "spring", unmappedSourcePolicy = org.mapstruct.ReportingPolicy.IGNORE,
        unmappedTargetPolicy = org.mapstruct.ReportingPolicy.IGNORE, uses = {SprintMapper.class})
...
//                        @Mapping(target = "timePerSprint", source = "timePerSprint"),
    ...
    @Mappings({@Mapping(target = "sprintNum", source = "workspaceUpdationRequest.sprintNum"),
