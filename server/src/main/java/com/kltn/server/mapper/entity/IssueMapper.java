...
public interface IssueMapper {
    ...
    @Mappings({@Mapping(target = "issue",
                        source = "relation.issue",
                        qualifiedByName = "toIssueResponseSimple"),
               @Mapping(target = "issueRelated",
                        source = "relation.issueRelated",
                        qualifiedByName = "toIssueResponseSimple"),
               @Mapping(target = "typeRelation",
                        source = "relation.typeRelation"),})
    IssueRelationResponse toIssueRelationResponse(IssueRelation relation);

    @Mappings({@Mapping(target = "issueRelated",
                        source = "relation.issueRelated",
                        qualifiedByName = "toIssueResponseSimple"),
               @Mapping(target = "typeRelation",
                        source = "relation.typeRelation"),})
    ...
    @Mappings({@Mapping(target = "name",
               ...
               @Mapping(target = "description",
                        source = "description"),
               @Mapping(target = "dtStart",
                        source = "start"),
               @Mapping(target = "dtEnd",
                        source = "end"),})
    @BeanMapping(ignoreByDefault = true)
    Issue toEntity(IssueCreateRequest issueCreateRequest);

    @Mappings({@Mapping(target = "nkTaskId",
                        source = "task.id"),
               @Mapping(target = "description",
                        source = "task.description"),
  //            @Mapping(target = "tag", source = "task.name"),
               @Mapping(target = "subtasks",
                        source = "issueCreateRequest.subtasks",
                        qualifiedByName = "toListDocument"),
               @Mapping(target = "attachment",
                        source = "issueCreateRequest.attachments",
                        qualifiedByName = "toListDocument"),
               @Mapping(target = "topics",
                        source = "issueCreateRequest.topics",
                        qualifiedByName = "toTopicList")})
    @BeanMapping(ignoreByDefault = true)
  ...
  //            @Mapping(target = "attachments", source = "issueMongo.attachment", qualifiedByName = "toListResponse"),
               @Mapping(target = "assignee",
                        source = "task.assignee",
                        qualifiedByName = "toUserDetailDTO"),
  ...
  //    List<IssueResponse> toIssueResponseList(List<Issue> issues, List<com.kltn.server.model.collection.Issue> issueMongo);
    ...
    @Mappings({@Mapping(target = "id",
               ...
               @Mapping(target = "reviewer",
                        ...
                        qualifiedByName = "toUserDetailDTO"),
               @Mapping(target = "topics",
                        source = "issueMongo.topics",
                        qualifiedByName = "toListResponse"),
               @Mapping(target = "subtasks",
                        source = "issueMongo.subtasks",
                        qualifiedByName = "toListResponse"),
               @Mapping(target = "resources",
                        source = "task.resources",
                        qualifiedByName = "toListResponse"),
               @Mapping(target = "complexOfDescription",
                        source = "task.complexOfDescription"),
               @Mapping(target = "dtStart",
                        source = "task.dtStart"),
               @Mapping(target = "dtEnd",
                        source = "task.dtEnd"),
               @Mapping(target = "relations",
                        source = "task.affectTo",
                        qualifiedByName = "toListIssueRelationResponse"),
    })
    @BeanMapping(ignoreByDefault = true)
    IssueDetailResponse toIssueDetailResponse(Issue task, com.kltn.server.model.collection.Issue issueMongo);

  @Mappings({@Mapping(target = "id",
                      source = "snapshot.nkTaskId"),
             @Mapping(target = "name",
             ...
             @Mapping(target = "topics",
                      source = "snapshot.topics",
                      qualifiedByName = "toListResponse"),
             @Mapping(target = "subtasks",
                      source = "snapshot.subtasks",
                      qualifiedByName = "toListResponse"),
             @Mapping(target = "resources",
                      source = "snapshot.resources",
                      qualifiedByName = "toListResponse"),
             @Mapping(target = "complexOfDescription",
                      source = "snapshot.complexOfDescription"),
             @Mapping(target = "dtStart",
                      source = "snapshot.dtStart"),
             @Mapping(target = "dtEnd",
                      source = "snapshot.dtEnd"),})
  @BeanMapping(ignoreByDefault = true)
