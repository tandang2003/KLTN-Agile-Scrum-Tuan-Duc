...
public interface IssueRepository extends JpaRepository<Issue, String> {
  ...
  int countByProjectIdAndSprintIdAndDtAppendLessThanEqual(String projectId, String sprintId, Instant dtAppendIsLessThan);

  int countByProjectIdAndSprintIdAndDtAppendGreaterThan(String projectId, String sprintId, Instant dtAppendIsGreaterThan);
}
